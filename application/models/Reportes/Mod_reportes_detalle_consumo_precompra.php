...
class Mod_reportes_detalle_consumo_precompra extends CI_Model {
   ...
   public function get_detalle_consumo_precompra($parametros){
    ...
    function validar_emd($proceso,$id_usuario){
      ...
      if($id_usuario == 42){
        ...
        if($proceso == 1){
          ...
          $str = $str.",GVC_TIPO_BOLETO varchar(500) null,GVC_EMD varchar(500) null";

        }
        if($proceso == 2){

          $str = $str.",DETALLE_FACTURA.contra as TIPO_BOLETO,DETALLE_FACTURA.EMD";

        }
        if($proceso == 3){

          $str = $str.",DETALLE_NC.det_nc_ctra as TIPO_BOLETO,NULL";

        }
        if($proceso == 4){

          $str = $str." ,GVC_TIPO_BOLETO,GVC_EMD";
    ...
    GVC_FECHA_RESERVACION varchar(500) null".validar_emd(1,$id_usuario)."
    )");
    ...
    $select1 = $select1." 
    and ".$condicion_fecha." between cast('".$fecha1."' as date) and cast('".$fecha2."' as date) and DETALLE_FACTURA.contra <> 'S' and DETALLE_FACTURA.EMD <> 'S' and PROV_TPO_SERV.ID_SERVICIO in('BD','BI')
    ";
    ...
    $select2 = $select2."
      ...
      and ".$condicion_fecha." between cast('".$fecha1."' as date) and cast('".$fecha2."' as date) and DETALLE_NC.det_nc_ctra <> 'S' and PROV_TPO_SERV.ID_SERVICIO in('BD','BI')
   ...
   if($all_dks == 0){
    ...
    GVC_CLAVE_EMPLEADO,
    GVC_FOR_PAG1,
    GVC_FECHA_RESERVACION".validar_emd(4,$id_usuario)."
