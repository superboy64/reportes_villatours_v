...
class Mod_reportes_detalle_pax extends CI_Model {
   ...
   public function get_pasajero($parametros){
    ...
    '' as GVC_ID_CORPORATIVO, 
    '' as GVC_ID_CLIENTE, 
    '' as GVC_NOM_CLI, 
    '' as GVC_ID_CENTRO_COSTO,  
    '' as GVC_DESC_CENTRO_COSTO,  
    ''  as GVC_FECHA,  
    '' as GVC_SOLICITO, 
    '' as GVC_CVE_RES_GLO, 
    '' as GVC_BOLETO, 
    ...
    '' as GVC_CLASE_FACTURADA, 
    '' as GVC_FECHA_SALIDA, 
    '' as GVC_FECHA_REGRESO,  
    '' as GVC_FECHA_EMISION_BOLETO,  
    '' as GVC_CLAVE_EMPLEADO, 
    '' as GVC_FOR_PAG1,  
    '' as GVC_FECHA_RESERVACION
    ...
    $select3 = "select GVC_NOM_PAX=LTRIM(RTRIM(FAC.GVC_NOM_PAX)),";


    $select3 = $select3 . "
                            GVC_TARIFA_MON_BASE=SUM(GVC_TARIFA_MON_BASE),
                            GVC_IVA=SUM(GVC_IVA),
                            GVC_TUA=SUM(GVC_TUA),
                            GVC_OTROS_IMPUESTOS=SUM(GVC_OTROS_IMPUESTOS),
                            total=SUM(total)
                           ";
    ...
    $select3 = $select3 . " group by LTRIM(RTRIM(FAC.GVC_NOM_PAX)) ORDER BY GVC_NOM_PAX ASC";
   ...
   public function get_pasajero_detalle($parametros){
    ...
    $select3 = $select3 . " ORDER BY FAC.GVC_NOM_PAX ASC";
