...
class Mod_reportes_serv_24hrs_bol_cc_rev extends CI_Model {
   ...
   public function get_grafica_pasajero($parametros){
    ...
    $this->db->query("create table #TEMPNUEVO(
     AGENT varchar(200) null,
     GVC_ID_SERVICIO varchar(20) null,
     GVC_ID_PROVEEDOR varchar(20) null,
     TOTAL real null,
     TOTAL_BOL real null
    )");
    ...
    $select3 = "insert into #TEMPNUEVO

    select AGENT = FAC.GVC_NOM_VEN_TIT,FAC.GVC_ID_SERVICIO,FAC.GVC_ID_PROVEEDOR,
    ...
    from #TEMPFAC AS FAC1 WHERE not FAC1.GVC_DOC_NUMERO = any(select distinct GVC_FAC_NUMERO from #TEMPNC) AND FAC1.GVC_NOM_VEN_TIT = FAC.GVC_NOM_VEN_TIT AND FAC1.GVC_ID_PROVEEDOR = FAC.GVC_ID_PROVEEDOR and FAC1.GVC_ID_SERVICIO IN('BD','BI')),
    ...
    group by FAC.GVC_NOM_VEN_TIT,FAC.GVC_ID_PROVEEDOR,FAC.GVC_ID_SERVICIO


    ";

    $this->db->query($select3);
    ...
    $query_rows = $this->db->query($select4);
    ...
    $this->db->query("drop table #TEMPNUEVO");
   ...
   public function get_provedores_servicio($parametros){
    ...
    $select3 = "
    select AGENT = FAC.GVC_NOM_VEN_TIT,FAC.GVC_ID_SERVICIO,FAC.GVC_ID_PROVEEDOR,FAC.GVC_NOMBRE_PROVEEDOR,";
    ...
    from #TEMPFAC AS FAC1 WHERE not FAC1.GVC_DOC_NUMERO = any(select distinct GVC_FAC_NUMERO from #TEMPNC) AND FAC1.GVC_NOM_VEN_TIT = FAC.GVC_NOM_VEN_TIT AND FAC1.GVC_ID_PROVEEDOR = FAC.GVC_ID_PROVEEDOR and FAC.GVC_ID_SERVICIO IN('BD','BI')),
    ...
    group by FAC.GVC_NOM_VEN_TIT,FAC.GVC_ID_SERVICIO,FAC.GVC_ID_PROVEEDOR,FAC.GVC_NOMBRE_PROVEEDOR order by TOTAL_BOL desc";
