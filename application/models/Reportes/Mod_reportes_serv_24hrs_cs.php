...
class Mod_reportes_serv_24hrs_cs extends CI_Model {
   ...
   public function get_grafica_pasajero($parametros){
    ...
    and DATOS_FACTURA.FECHA BETWEEN '".$fecha1."' AND '".$fecha2."' and prov_tpo_serv.ID_PROVEEDOR = 'CS'";
    ...
    and NOTAS_CREDITO.NC_FEC BETWEEN '".$fecha1."' AND '".$fecha2."' and prov_tpo_serv.ID_PROVEEDOR = 'CS'";
    ...
    $select3 = "select top 10 AGENT = FAC.GVC_NOM_VEN_TIT,";
    ...
    from #TEMPFAC AS FAC1 WHERE not FAC1.GVC_DOC_NUMERO = any(select distinct GVC_FAC_NUMERO from #TEMPNC) AND FAC1.GVC_NOM_VEN_TIT = FAC.GVC_NOM_VEN_TIT),";
    ...
    $select3 = $select3 . " group by FAC.GVC_NOM_VEN_TIT order by TOTAL_BOL desc";
   ...
   public function get_provedores_servicio($parametros){
    ...
    $select3 = "select AGENT = FAC.GVC_NOM_VEN_TIT ,GVC_ID_SERVICIO,
    ...
    from #TEMPFAC AS FAC1 WHERE not FAC1.GVC_DOC_NUMERO = any(select distinct GVC_FAC_NUMERO from #TEMPNC) AND FAC1.GVC_NOM_VEN_TIT = FAC.GVC_NOM_VEN_TIT AND FAC1.GVC_ID_SERVICIO = FAC.GVC_ID_SERVICIO),
    ...
    group by FAC.GVC_NOM_VEN_TIT,FAC.GVC_ID_SERVICIO order by TOTAL_BOL desc";
