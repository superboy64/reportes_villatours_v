...
class Mod_reportes_graficos_rut extends CI_Model {
...
UNION ALL
    ...
    $select2 = "select top 10 GVC_RUTA=SUP.GVC_RUTA,";
         ...
         if($id_servicio == 'BD'){
          ...
          from #NombreTabla6 WHERE GVC_ID_SERVICIO = 'BD' AND GVC_RUTA = SUP.GVC_RUTA),BOL_INT = 0,";
         ...
         if($id_servicio == 'BI'){
          ...
          from #NombreTabla6 WHERE GVC_ID_SERVICIO = 'BI' AND GVC_RUTA = SUP.GVC_RUTA),";

         }
     
    $select2 = $select2 . "TOTAL_BOL=SUM(case when(SUP.GVC_TIPO = 'F') then 1 else-1 end) from #NombreTabla6 AS SUP where 1=1 and SUP.GVC_ID_SERVICIO = '".$id_servicio."' ";

    $select2 = $select2 . " group by SUP.GVC_RUTA order by TOTAL_BOL desc";
