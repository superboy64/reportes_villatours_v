...
ini_set('memory_limit', '3.99G');

class Mod_reportes_gastos_ae extends CI_Model {
...
UNION ALL
    ...
    $select2 = "select top 10 NOMBRE_PAX=SUP.GVC_NOM_PAX,";
         ...
         if($id_servicio == 'BD'){
          ...
          from #NombreTabla6 WHERE GVC_ID_SERVICIO = 'BD' AND GVC_NOM_PAX = SUP.GVC_NOM_PAX),BOL_INT = 0,";
         ...
         if($id_servicio == 'BI'){
          ...
          from #NombreTabla6 WHERE GVC_ID_SERVICIO = 'BI' AND GVC_NOM_PAX = SUP.GVC_NOM_PAX),";
    ...
    $select2 = $select2 . " group by SUP.GVC_NOM_PAX order by TOTAL_BOL desc";
