...
class Mod_reportes_detalle_cc extends CI_Model {
   ...
   public function get_pasajero($parametros){
    ...
    $select3 = "select GVC_ID_CENTRO_COSTO=LTRIM(RTRIM(FAC.GVC_ID_CENTRO_COSTO)),";
    ...
    $select3 = $select3 . " group by LTRIM(RTRIM(FAC.GVC_ID_CENTRO_COSTO))";
   ...
   public function get_pasajero_detalle($parametros){
    ...
    $select3 = $select3 . " ORDER BY FAC.GVC_ID_CENTRO_COSTO ASC";
