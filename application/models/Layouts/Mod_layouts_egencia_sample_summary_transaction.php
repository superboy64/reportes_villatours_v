...
class Mod_layouts_egencia_sample_summary_transaction extends CI_Model {
...
select         
      ...
      precompra= datediff(dd, cast(CONCECUTIVO_BOLETOS.FECHA_EMI as date) , cast(CONCECUTIVO_BOLETOS.FECHA_SAL as date)),

      detalle_factura.detalle_factura as codigo_detalle,
      detalle_factura.bol_contra as bol_origi,
    ...
    $select = $select ."union 
     ...
     SELECT 
      ...
      DETALLE_NC.DET_NC_BOCTRA as bol_origi,
