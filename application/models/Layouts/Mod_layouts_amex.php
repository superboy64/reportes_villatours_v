...
class Mod_layouts_amex extends CI_Model {
   ...
   public function lay_amex($parametros,$cat_provedor){
      ...
      $fecha2 = $array_fecha2[2].'-'.$array_fecha2[1].'-'.$array_fecha2[0];
                  ...
                  $array_campos_query_fc['AMEX_BOLETO'] = "case when ( PROV_TPO_SERV.ID_SERVICIO = 'CS' or prov_tpo_serv.id_servicio = 'CSE' or prov_tpo_serv.id_servicio = 'CSFE') then  DETALLE_FACTURA.numero_bol_Cxs else DETALLE_FACTURA.NUMERO_BOL  end as AMEX_BOLETO";
                  ...
                  $array_campos_query_nc['AMEX_BOLETO'] = "case when (prov_tpo_serv.id_servicio = 'CS' or prov_tpo_serv.id_servicio = 'CSE' or prov_tpo_serv.id_servicio = 'CSFE') then (select detalle_factura.numero_bol from datos_factura
