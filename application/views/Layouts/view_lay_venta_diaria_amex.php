                    ...
                    success: function (data) {
                        ...
                        $("#dg").jqGrid({
                                ...
                                colModel:[
                                          ...
                                          {name:'GVC_ID_SERIE',index:'GVC_ID_SERIE',sorttype:"int",width: 80, editable:true},
                                          {name:'GVC_DOC_NUMERO',index:'GVC_DOC_NUMERO',sorttype:"int",width: 90, editable:true},
                                          {name:'NUMERO_BOLETO',index:'NUMERO_BOLETO',sorttype:"int",width: 135, editable:true},
                                          {name:'NUMERO_CUPON',index:'NUMERO_CUPON',sorttype:"int",width: 80, editable:true},
                                          //{name:'GVC_ID_SUCURSAL',index:'GVC_ID_SUCURSAL',sorttype:"int",width: 250, editable:true},
                                          {name:'FECHA',index:'FECHA',sorttype:"int",width: 90, editable:true},
                                          ...
                                          {name:'NUMERO_CUENTA',index:'NUMERO_CUENTA',sorttype:"int",width: 160, editable:true},
                                          {name:'analisis27_cliente',index:'analisis27_cliente',sorttype:"int",width: 180, editable:true},
                                          {name:'GVC_ID_CORPORATIVO',index:'GVC_ID_CORPORATIVO',sorttype:"int",width: 150, editable:true},
                                          {name:'ID_FORMA_PAGO',index:'ID_FORMA_PAGO',sorttype:"int",width: 170, editable:true},
                                          {name:'c_FormaPago',index:'c_FormaPago',sorttype:"int",width: 170, editable:true},
                                          {name:'GVC_RUTA',index:'GVC_RUTA',sorttype:"int",width: 250, editable:true},
                                          {name:'GVC_ID_PROVEEDOR',index:'GVC_ID_PROVEEDOR',sorttype:"int",width: 160, editable:true},
                                          {name:'GVC_NOMBRE_PROVEEDOR',index:'GVC_NOMBRE_PROVEEDOR',sorttype:"int",width: 250, editable:true},
                                          {name:'GVC_TARIFA',index:'GVC_TARIFA',sorttype:"int",width: 100, editable:true},
                                          {name:'GVC_IVA',index:'GVC_IVA',sorttype:"int",width: 100, editable:true},
                                          {name:'GVC_TUA',index:'GVC_TUA',sorttype:"int",width: 100, editable:true},
                                          {name:'GVC_OTROS_IMPUESTOS',index:'GVC_OTROS_IMPUESTOS',sorttype:"int",width: 100, editable:true},
                                          {name:'GVC_NOM_VEN_TIT',index:'GVC_NOM_VEN_TIT',sorttype:"int",width: 200, editable:true},
                                          {name:'CONCEPTO',index:'CONCEPTO',sorttype:"int",width: 200, editable:true},
                                          {name:'GVC_TOTAL',index:'GVC_TOTAL',sorttype:"int",width: 100, editable:true},
                                          ...
                                          {name:'GVC_ID_SERVICIO',index:'GVC_ID_SERVICIO',sorttype:"int",width: 80, editable:true},
