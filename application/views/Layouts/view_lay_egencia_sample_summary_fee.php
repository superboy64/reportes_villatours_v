...
<script type="text/javascript">
  ...
  function get_layouts_egencia_data_import_sp(){
        ...
        $("#dg_rep_ficosa").clearGridData(true).trigger("reloadGrid");
            ...
            var tipo_funcion = 'man';
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/Layouts/Cnt_layouts_egencia_sample_summary_fee/get_layouts_egencia_data_import_sp_parametros",
                    type: 'POST',
                      ...
                      data = JSON.parse(data);
                       ...
                       $("#dg_rep_ficosa").jqGrid({
                          ...
                          colModel:[
                                      ...
                                      {name:'Booking_Method',index:'Booking_Method',width: 250},
                                      {name:'Air_Fee_Net_Amount',index:'Air_Fee_Net_Amount',width: 250},
                                      {name:'Air_Fee_Net_Count',index:'Air_Fee_Net_Count',width: 250},
                                      {name:'Train_Fee_Net_Amount',index:'Train_Fee_Net_Amount',width: 250},
                                      {name:'Train_Fee_Net_Count',index:'Train_Fee_Net_Count',width: 250},
                                      {name:'Hotel_Fee_Net_Amount',index:'Hotel_Fee_Net_Amount',width: 250},
                                      {name:'Hotel_Fee_Net_Count',index:'Hotel_Fee_Net_Count',width: 250},
                                      {name:'Car_Fee_Net_Amount',index:'Car_Fee_Net_Amount',width: 250},
                                      {name:'Car_Fee_Net_Count',index:'Car_Fee_Net_Count',width: 250},
                                      {name:'Towncar_Fee_Net_Amount',index:'Towncar_Fee_Net_Amount',width: 250},
                                      {name:'Towncar_Fee_Net_Count',index:'LinkTowncar_Fee_Net_Count_Key',width: 250},
                                      {name:'Other_Ground_Transportation_Fee_Net_Amount',index:'Other_Ground_Transportation_Fee_Net_Amount',width: 250},
                                      {name:'Other_Ground_Transportation_Fee_Net_Count',index:'Other_Ground_Transportation_Fee_Net_Count',width: 250},
                                      {name:'Other_Services_Fee_Net_Amount',index:'Other_Services_Fee_Net_Amount',width: 250},
                                      {name:'Other_Services_Fee_Net_Count',index:'Other_Services_Fee_Net_Count',width: 250}
  ...
  function btn_exportar_excel_rep_ficosa(){
           ...
           if(id_cliente.length == 0 && id_corporativo == ""){
                ...
                window.open('<?php echo base_url(); ?>index.php/Layouts/Cnt_layouts_egencia_sample_summary_fee/get_layouts_egencia_data_import_sp_parametros?parametros='+parametros+'&tipo_funcion=ex', 'download_window');
