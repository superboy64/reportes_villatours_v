  ...
  function get_layouts_egencia_data_import_sp(){
        ...
        $("#dg_rep_ficosa").clearGridData(true).trigger("reloadGrid");
            ...
            var tipo_funcion = 'man';
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/Layouts/Cnt_layouts_egencia_udids/get_layouts_egencia_data_import_sp_parametros",
                    type: 'POST',
                    ...
                    success: function (data) {
                      data = JSON.parse(data);
                       ...
                       $("#dg_rep_ficosa").jqGrid({
                          ...
                          shrinkToFit:false,
                          forceFit:true,
                          colNames:['Link_Key','BookingID','UdidNumber','UdidValue','UdidDefinitions'],
                          colModel:[
                                     
                                      {name:'Link_Key',index:'Link_Key',width: 250},
                                      {name:'BookingID',index:'BookingID',width: 250},
                                      {name:'UdidNumber',index:'UdidNumber',width: 250},  
                                      {name:'UdidValue',index:'UdidValue',width: 250},
                                      {name:'UdidDefinition',index:'UdidDefinition',width: 250}
           ...
           if(id_cliente.length == 0 && id_corporativo == ""){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        window.open('<?php echo base_url(); ?>index.php/Layouts/Cnt_layouts_egencia_udids/exportar_txt_lay_egencia_data_import_sp');            
