...
<div class="row">
      ...
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-default" onclick="btn_exportar_excel_rep_total_pre_ae();"><span class="fa fa-file-excel" style="color:#2fb30e;"></span>&nbsp;Descargar</button>
...
<script type="text/javascript">
  ...
  $("#div_select_multiple_id_servicio_ae").show();
  $("#div_select_multiple_id_provedor").show();
  $("#div_select_multiple_id_corporativo").show();
  
  function buscar(){

    btn_rep_total_precompra_aerea();

  }

  function btn_rep_total_precompra_aerea(){
            ...
            var id_servicio = $("#slc_mult_id_servicio_ae").val();
                    ...
                    success: function (data) {
                        ...
                        if(data.length > 0){
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_total_precompra_aerea/get_rep_total_precompra_aerea_html",
                                type: 'POST',
...
function btn_exportar_excel_rep_total_pre_ae(){
                        ...
                        $("#div_datagrid_html").empty();
                          ...
                          if(data.length > 0){
                            ...
                            $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_total_precompra_aerea/exportar_excel_total_pre",
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                    ...
                                    //$a.html("LNK");
                                    $("body").append($a);
                                    $a.attr("download","Reporte_total_pre_"+opResult.str_fecha+".xlsx");
                                    $a[0].click();
                                    $a.remove();
