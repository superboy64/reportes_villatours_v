                    ...
                    success: function (data) {
                        ...
                        if(arr_grafica.length > 0){
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_serv_24hrs_cs/get_grafica_pasajero_html",
                                type: 'POST',
                    ...
                    success: function (data) {
                        ...
                        data = JSON.parse(data);
                            ...
                            $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_serv_24hrs_cs/exportar_excel_ae",
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                    ...
                                    //$a.html("LNK");
                                    $("body").append($a);
                                    $a.attr("download","Reporte_Serv_24hrs_cs_"+opResult.str_fecha+".xlsx");
                                    $a[0].click();
                                    $a.remove();

                                    $("#div_datagrid_grafica").html("");
