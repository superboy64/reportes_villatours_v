<div class="row">
      ...
      <div class="col-md-12">
            <button type="button" class="btn btn-default" onclick="btn_exportar_rep_gvc(1);"><span class="fa fa-file-excel" style="color:#2fb30e;"></span>&nbsp;Descargar</button>
...
<script type="text/javascript">
  ...
  $("#div_plantilla").show();
	...
	function get_rep_gvc_reporteador_net(){
            ...
            $.ajax({
                    url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gvc_reporteador_net/get_rep_gvc_reporteador_net",
                    type: 'POST',
      ...
      function btn_exportar_rep_gvc(formato){
            ...
            if(formato == 1){
              ...
              $.ajax({
                url: '<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gvc_reporteador_net/excel_usuario_masivo_pipes?parametros='+parametros+'&tipo_funcion=rep',
                type: 'POST',
                ...
                success: function (data) {
                    ...
                    window.open('<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gvc_reporteador_net/exportar_excel_usuario_masivo_pipes?parametros='+parametros);
