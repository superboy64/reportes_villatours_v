                    ...
                    success: function (data) {
                        ...
                        if(arr_grafica.length > 0){
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_serv_24hrs/get_grafica_pasajero_html",
                                type: 'POST',
                    ...
                    success: function (data) {
                        ...
                        $("#div_datagrid_html").empty();
                            ...
                            $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_serv_24hrs/exportar_excel_ae",
