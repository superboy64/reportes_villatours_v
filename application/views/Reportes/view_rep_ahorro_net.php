                    ...
                    success: function (data) {
                        ...
                        if(data.length > 0){
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_ahorro_net/get_pasajero_html",
                                type: 'POST',
                        ...
                        $("#div_datagrid_html").empty();
                          ...
                          if(data.length > 0){
                            ...
                            $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_ahorro_net/exportar_excel_ae",
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                    ...
                                    //$a.html("LNK");
                                    $("body").append($a);
                                    $a.attr("download","Reporte_detalle_cc_"+opResult.str_fecha+".xlsx");
                                    $a[0].click();
                                    $a.remove();
