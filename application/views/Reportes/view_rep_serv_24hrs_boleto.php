                    ...
                    success: function (data) {
                        ...
                        if(arr_grafica.length > 0){
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_serv_24hrs_boleto/get_grafica_pasajero_html",
                                type: 'POST',
                    ...
                    success: function (data) {
                        ...
                        $("#div_datagrid_html").empty();
                            ...
                            $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_serv_24hrs_boleto/exportar_excel_ae",
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                    ...
                                    $("body").append($a);
                                    $a.attr("download","Reporte_Serv_24hrs_boleto_"+opResult.str_fecha+".xlsx");
                                    $a[0].click();
                                    $a.remove();
