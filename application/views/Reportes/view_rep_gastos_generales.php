<div class="row">
      ...
      <div class="col-md-12">
        ...
        <!--<button type="button" class="btn btn-default" onclick="btn_exportar_excel();"><span class="fa fa-file-excel" style="color:#2fb30e;"></span>&nbsp;Descargar</button>-->
...
<script type="text/javascript">
        ...
        var parametros = {};
          ...
          if(id_cliente.length == 0 && id_corporativo.length == 0){
            ...
            btn_exportar_excel_rep_gast_gen();
               ...
               $.ajax({
                      url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gastos_gen/get_rep_gastos_generales",
                      type: 'POST',
  ...
  function btn_grafica_rep_gast_gen(){
          ...
          $.ajax({
                    url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gastos_gen/get_prueba_grafica",
                    type: 'POST',
  ...
  function btn_exportar_excel(){  //manera de axceder al doom y trabajar la info sin volver  realizar la consulta

    var body = $('#dg_rep_gast_gen').datagrid();
    //console.log(body);
  ...
  function btn_exportar_excel_rep_gast_gen(){
            ...
            //window.open('<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gastos_gen/exportar_excel_usuario?parametros='+parametros+'&tipo_funcion=rep');
            
            window.open('<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gastos_gen/exportar_excel_usuario?parametros='+parametros+'&tipo_funcion=rep', 'download_window');
             ...
             /*$.ajax({
                    ...
                    url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_gastos_gen/exportar_excel_usuario",
