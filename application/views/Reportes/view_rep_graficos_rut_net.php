...
<div class="row">
      ...
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-default" onclick="btn_exportar_excel_rep_gastos_Rut();"><span class="fa fa-file-excel" style="color:#2fb30e;"></span>&nbsp;Descargar</button>
...
<script type="text/javascript">
  ...
  function buscar(){
    ...
    btn_grafica_rep_graficas_rut();

  }

  function btn_grafica_rep_graficas_rut(){
                        ...
                        var arr_grafica =  data['grafica'];
                            ...
                            var myLine = new Chart(document.getElementById("bar-chart-grouped"), {
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_graficos_rut_net/get_grafica_rutas_html",
                                type: 'POST',
...
function btn_exportar_excel_rep_gastos_Rut(){
                            ...
                            $.ajax({
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                      ...
                                      //$a.html("LNK");
                                      $("body").append($a);
                                      $a.attr("download","Reporte_Graficos_rut_net_"+opResult.str_fecha+".xlsx");
                                      $a[0].click();
                                      $a.remove();
