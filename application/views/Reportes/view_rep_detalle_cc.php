                    ...
                    success: function (data) {
                        ...
                        if(data.length > 0){
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_detalle_cc/get_pasajero_html",
                                type: 'POST',
                        ...
                        $("#div_datagrid_html").empty();
                          ...
                          if(data.length > 0){
                            ...
                            $.ajax({
                              ...
                              url:"<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_detalle_cc/exportar_excel_ae",
