                        ...
                        if(arr_grafica.length > 0){
                            ...
                            var myLine = new Chart(document.getElementById("bar-chart-grouped"), {
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_pasajero_servicio/get_grafica_pasajero_html",
                                type: 'POST',
                            ...
                            $.ajax({
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                    ...
                                    //$a.html("LNK");
                                    $("body").append($a);
                                    $a.attr("download","Reporte_Total_Pasajero_servicio_net_"+opResult.str_fecha+".xlsx");
                                    $a[0].click();
                                    $a.remove();
