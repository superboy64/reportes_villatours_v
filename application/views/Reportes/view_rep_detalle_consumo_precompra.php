<div class="row">
      ...
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-default" onclick="btn_exportar_rep_detalle_consumo_precompra();"><span class="fa fa-file-excel" style="color:#2fb30e;"></span>&nbsp;Descargar</button>
      ...
      <div class="col-md-12">
                ...
                <div id="div_datagrid" style="height: 80%; overflow-x: auto;">
                      ...
                      <table id="dg_rep_detalle_consumo_precompra"></table>
...
<script type="text/javascript">
  ...
  function get_detalle_consumo_precompra(){
      
      $("#dg_rep_detalle_consumo_precompra").clearGridData(true).trigger("reloadGrid");
        ...
        var parametros = {};
          ...
          if(id_cliente.length == 0){
            ...
            btn_exportar_rep_detalle_consumo_precompra();
               ...
               $.ajax({
                      ...
                      success: function (data) {
                         ...
                         $("#dg_rep_detalle_consumo_precompra").jqGrid({
                            datatype: "local",
                            height: 500,
                            shrinkToFit:false,
                            forceFit:true,
                            colNames:['SERIE','DOCUMENTO','CORPORATIVO','CLIENTE','NOMBRE CLIENTE','CC','DESC CC','FECHA DOCUMENTO','QUIEN SOLICITO','PNR','BOLETO','CVE DE SERVICIO','CVE DE PROVEEDOR','RUTA','PASAJERO','TARIFA','IVA','TUA','OTROS IMPUESTOS','TOTAL','CLASE','FECHA DE SALIDA','FECHA DE REGRESO','FECHA DE EMISION','GVC_PRECOMPRA','GVC_ID_PRECOMPRA','NUMERO DE EMPLEADO','CVE FORMA DE PAGO','FECHA DE RESERVACION'],
                            colModel:[
                                        ...
                                        {name:'GVC_PRECOMPRA',index:'GVC_PRECOMPRA',width: 250},
                                        {name:'GVC_ID_PRECOMPRA',index:'GVC_ID_PRECOMPRA',width: 250},
                  ...
                  for(var i=0;i<=data['rep'].length;i++){
                    $("#dg_rep_detalle_consumo_precompra").jqGrid('addRowData',i+1,data['rep'][i]);
                  }
  ...
  function btn_exportar_rep_detalle_consumo_precompra(){
            ...
            window.open('<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_detalle_consumos_precompra/exportal_excel_detalle_consumo_precompra?parametros='+parametros+'&tipo_funcion=rep');
