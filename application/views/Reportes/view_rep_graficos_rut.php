                        ...
                        var arr_grafica =  data['grafica'];
                            ...
                            var myLine = new Chart(document.getElementById("bar-chart-grouped"), {
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>index.php/Reportes/Cnt_reportes_graficos_rut/get_grafica_rutas_html",
                                type: 'POST',
                            ...
                            $.ajax({
                              ...
                              success: function (data) {
                                ...
                                if(data != 0){
                                    ...
                                    //$a.html("LNK");
                                    $("body").append($a);
                                    $a.attr("download","Reporte_Graficos_rut_"+opResult.str_fecha+".xlsx");
                                    $a[0].click();
                                    $a.remove();
