    ...
    <br>
        ...
        <div class="row">
           ...
           <div class="col-md-3">
              ...
              <label>Categoria aereolinea:&nbsp;</label><br>
           ...
           <div class="col-md-3">
              ...
              <label>Categoria cuenta:&nbsp;</label><br>
            
              <select id="slc_cat_cuenta" class="form-control">
           ...
           <div class="col-md-3">
              ...
              <input type="text" class="form-control" id="txt_CODIGO_NUMERICO">
           ...
           <div class="col-md-3">
              ...
              <input type="text" class="form-control" id="txt_CODIGO_TIMBRE">
...
<script type="text/javascript">
  ...
  function guardar_aereolinea_CFDI(){
    
    var slc_cat_aereolinea = $("#slc_cat_aereolinea").val();
    var slc_cat_cuenta = $("#slc_cat_cuenta").val();
    var txt_CODIGO_NUMERICO = $("#txt_CODIGO_NUMERICO").val();
    var txt_CODIGO_TIMBRE = $("#txt_CODIGO_TIMBRE").val();

    
    var row_aereolineas_sele = $('#dg_aereolineas_seleccionadas').datagrid('getRows');

    $.post("<?php echo base_url(); ?>index.php/Cnt_aereolineas_CFDI/guardar_aereolinea_CFDI", {arr_prov:JSON.stringify(row_aereolineas_sele),slc_cat_aereolinea:slc_cat_aereolinea,slc_cat_cuenta:slc_cat_cuenta,txt_CODIGO_NUMERICO:txt_CODIGO_NUMERICO,txt_CODIGO_TIMBRE:txt_CODIGO_TIMBRE}, function(data){

         if(data == 1){

          swal("Aereolinea guardada correctamente");
