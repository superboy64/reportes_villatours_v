...
<script type="text/javascript">
  ...
  function formatField(value){
	...
	function get_aereolineas(status){
      ...
      $('#dg').datagrid({
            url:"<?php echo base_url(); ?>index.php/Cnt_aereolineas_CFDI/get_catalogo_aereolineas_CFDI_local",
            columns:[[
                  ...
                  {field:'id_categoria_aereolinea',title:'id_categoria_aereolinea',formatter:formatField,
                      formatter: function(value,row,index){
                         ...
                         if(value == 1){
                          ...
                          var d = '<p style="font-size:10px; color:#010101;">aereomexico</p>';

                         }else{

                           var d = '<p style="font-size:10px; color:#010101;">otras aereolineas</p>';
                  ...
                  {field:'bajo_costo',title:'Categoria cuenta',formatter:formatField,formatter: function(value,row,index){

                         if(value == 1){

                          var d = '<p style="font-size:10px; color:#010101;">BC</p>';

                         }else{

                           var d = '<p style="font-size:10px; color:#010101;">BSP</p>';
                  ...
                  {field:'codigo_numerico',title:'codigo_numerico',formatter:formatField},
                  {field:'codigo_timbre',title:'codigo_timbre',formatter:formatField},
	...
	function btn_agregar_aereolinea(){
		...
		rest_modal('guardar_aereolinea_CFDI();');

		$("#modal_content").css({"width": "50%"});

		$.post("<?php echo base_url(); ?>index.php/Cnt_aereolineas_CFDI/get_html_agregar_aereolinea_CFDI", {suggest: ''}, function(data){
    ...
    var id_aereolinea = row_aereolinea[0]['id'];
		...
		rest_modal('mod_guardar_actualizacion_aereolineas_CFDI();');

		$("#modal_content").css({"width": "20%"});

		var row_aereolinea = $('#dg').datagrid('getSelections')

		$.post("<?php echo base_url(); ?>index.php/Cnt_aereolineas_CFDI/get_html_actualizar_aereolinea_CFDI", {row_aereolinea:row_aereolinea}, function(data){
	...
	function btn_eliminar_aereolinea(){
		...
		$.post("<?php echo base_url(); ?>index.php/Cnt_aereolineas_CFDI/eliminar_aereolinea_CFDI", {id:id}, function(data){
