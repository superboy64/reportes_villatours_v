<div class="row">
  <div class="col-md-6">
              ...
              <option>seleccione</option>
                <?php
                    foreach ($sucursales as &$valor){
                       ...
                       if($valor['id_sucursal'] == $id_sucursal){
    ...
    <div class="form-group">
      <label>Nombre</label>
      <input type="text" class="form-control" id="txt_nombre" value="<?=$nombre_usuario?>" placeholder="Nombre">
    </div>
    <div class="form-group">
      <label>Usuario</label>
      <input type="usuario" class="form-control" id="txt_usuario" value="<?=$usuario?>" placeholder="Usuario">
    </div>
    <div class="form-group">
      <label>Password</label>
      <input type="password" class="form-control" id="txt_password" value="<?=$password?>" placeholder="Password">
    </div>
    <div class="form-group">
      <label>Perfil</label>
...
<script type="text/javascript">
      ...
      $('#dg_perfil_seleccionados').datagrid({
          ...
          columns: [[
            ...
            {field:'id_corporativo',title:'Corporativo',formatter:formatField,sortable:true}
                ...
                $.post("<?php echo base_url(); ?>index.php/Cnt_clientes/get_clientes_dk_perfil_not_in", {ids_selec: ids_selec,id_per:id_per}, function(data){
                            ...
                            $('#dg_perfil_clientes').datagrid({
                                  ...
                                  columns: [[
                                    ...
                                    console.log("se actualizaron los dks correctamento funcion(not in) 1");
    ...
    function get_catalogo_dks_seleccionados(id_usuario){
        ...
        $.post("<?php echo base_url(); ?>index.php/Cnt_perfiles/get_perfiles_id", {id_per:id_per}, function(data){
           ...
           if(all_dks == '0'){
              ...
              $('#dg_perfil_seleccionados').datagrid({ //inicializa la tabla de seleccionados
                  url:"<?php echo base_url(); ?>index.php/Cnt_clientes/get_catalogo_dks_seleccionados?id_usuario="+id_usuario,
                  onCheckAll: function(){
                    var state = $(this).data('datagrid');
                    state.selectedRows = $.extend(true,[],state.data.firstRows);
                    state.checkedRows = $.extend(true,[],state.data.firstRows);
                        ...
                        $.post("<?php echo base_url(); ?>index.php/Cnt_clientes/get_clientes_dk_perfil_not_in", {ids_selec: ids_selec,id_per:id_per}, function(data){
                            ...
                            $('#dg_perfil_clientes').datagrid({
                                  ...
                                  columns: [[
                                    ...
                                    console.log("se actualizaron los dks correctamento funcion(not in) 3");
    ...
    $.post("<?php echo base_url(); ?>index.php/Cnt_usuario/actualizar_usuario", {id_usuario:id_usuario,txt_nombre:txt_nombre,slc_sucursal:slc_sucursal,txt_usuario:txt_usuario,txt_password:txt_password,slc_dep:slc_dep,rows_clientes_selec_all:JSON.stringify(rows_clientes_selec_all),all_dks:all_dks}, function(data){
            ...
            if(data == 1){
               ...
               swal('Error al actualizar usuario');
            }
