		...
		if(count($rest_precompra) > 0){
			...
			$spreadsheet->getActiveSheet()->getColumnDimension('E')->setWidth(20);
				...
				if($tipo_funcion == "aut"){
			       	...
			       	$Excel_writer->save($_SERVER['DOCUMENT_ROOT'].'/reportes_villatours/referencias/archivos/Reporte_total_precompra_ae_'.$str_fecha.'_'.$id_correo_automatico.'_'.$id_reporte.'.xlsx');
