...
class Cnt_reportes_graficos_ae extends CI_Controller {

	public function __construct()
	{
	      parent::__construct();
	      $this->load->model('Reportes/Mod_reportes_graficos_ae');
	...
	public function get_html_rep_graficos_ae(){
		...
		$this->load->view('Reportes/view_rep_graficos_ae');
		...
		$ids_corporativo = array_filter($ids_corporativo, "strlen");
  	    ...
  	    $ids_cliente = array_filter($ids_cliente, "strlen");
            ...
            if(count($ids_corporativo) > 0 ){
                ...
                $rz = $this->Mod_reportes_graficos_ae->get_razon_social_id_in($ids_cliente);  //optiene razon social
	...
	public function get_grafica_provedor(){
		...
		$rest_grafica = $this->Mod_reportes_graficos_ae->get_grafica_provedor($parametros);
	...
	public function exportar_excel_ae(){
		...
		$rest_dat_BD = $this->Mod_reportes_graficos_ae->get_datos_grafica($parametros,'BD');
		$rest_dat_BI = $this->Mod_reportes_graficos_ae->get_datos_grafica($parametros,'BI');
