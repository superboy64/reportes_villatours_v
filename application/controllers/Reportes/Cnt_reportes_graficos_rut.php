...
class Cnt_reportes_graficos_rut extends CI_Controller {
	...
	public function exportar_excel_ae(){
		...
		$drawing->setPath($_SERVER['DOCUMENT_ROOT'].'/reportes_villatours/referencias/archivos/rep_graficos_rut_'.$id_us.'.png');
		...
		if($tipo_funcion == "aut"){
			...
			$str_fecha = $fecha1.'_A_'.$fecha2;
	       	$Excel_writer->save($_SERVER['DOCUMENT_ROOT'].'/reportes_villatours/referencias/archivos/Reporte_Graficos_rut_'.$str_fecha.'_'.$id_correo_automatico.'_'.$id_reporte.'.xlsx');
